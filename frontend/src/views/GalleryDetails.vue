<template>
  <b-container class="page-container">
    <div class="sponsor-header">
      <router-link to="/sponsors" class="back-button-container">
        <ChevronIcon class="btn-icon btn-icon-left" />Back To Sponsors
      </router-link>
    </div>
          ...
          <b-col md="8" class="sponsor-body-left">
            ...
            >
              <b-carousel-slide v-for="image in sponsor.images" :key="image" class="carousel-slide">
                <template slot="img">
                  <img
                    src="https://challengepost-s3-challengepost.netdna-ssl.com/photos/production/software_photos/001/263/209/datas/gallery.jpg"
            ...
            <div class="sponsor-description">
              <span>Hello This is a description</span>
            </div>
            <h4 class="project-info-title">
              <span>Elevator Pitch</span>
            </h4>
            <div class="sponsor-description">
              <span>Hello this is a elevator pitch</span>
            </div>
            <h4 class="project-info-title">
            ...
            <div class="sponsor-description">
              <a class="try-it-out-link-style" href="www.gotechnica.org">www.gotechnica.org</a>
            </div>
          </b-col>
          <b-col col> </b-col>
        </b-row>
...
export default {
  ...
  async mounted() {
    ...
    params.id = 'bc96a5cf-97fe-4956-aa79-e68e3f3cdebd';
  ...
  methods: {
    async trackSponsorBoothActivity(activityName) {
      ...
      if (activityName === 'VIEW_BOOTH') {
        ...
        const resp = await this.addAchievement(
          this.getUserId(),
          achievementName,
          'view-sponsor-booth',
        );
