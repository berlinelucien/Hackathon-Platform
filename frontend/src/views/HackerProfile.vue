  ...
  <div class="page-container">
    ...
    >
      <div class="profile-header">
        ...
        />
        <div class="profile-header-title ml-3">
      ...
      <p v-if="!this.urlUserId">
        Your hacker profile is an optional way for you to share more information
        about yourself with the event sponsors. Only sponsors can see this
        information.
      </p>
      <div class="profile-footer row">
        <div class="profile-footer-box">
          ...
          <p
            v-if="profile.email"
            class="profile-footer-box-content"
          >
            <a
          ...
          >
            <a
              :href="this.getClickableLink(profile.linkedin)"
              target="_blank"
            >My LinkedIn</a>
          </p>
          <p
          ...
          >
            <a
              :href="this.getClickableLink(profile.github)"
              target="_blank"
            >My Github</a>
          </p>
        ...
        <div
          class="profile-footer-box"
          v-if="profile.school || !this.urlUserId"
        >
        ...
        <div
          class="profile-footer-box"
          v-if="profile.project_description || !this.urlUserId"
        >
          <h5 class="profile-footer-box-title">Our Hack:</h5>
          <p
            v-if="profile.project_description"
            class="profile-footer-box-content"
          >
            {{ profile.project_description }}
          </p>
          <p
            v-if="profile.devpost"
            class="profile-footer-box-content"
          >
            <a
              :href="this.getClickableLink(profile.devpost)"
              target="_blank"
            >Link to Project
              <img
                src="../assets/link.svg"
